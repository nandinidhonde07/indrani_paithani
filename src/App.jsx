    ...
    <div className="flex flex-col min-h-screen font-body bg-cream text-black relative">
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gold/20 shadow-2xl z-40 flex justify-around py-3">
        ...
        <Link 
          to={
            isAuthenticated 
              ? (role === 'owner' ? '/admin' : '/buyer-dashboard')
              : '/buyer-login'
          } 
          className="flex flex-col items-center text-maroon hover:text-gold transition"
        >
          <FaUser size={18} />
          <span className="text-[9px] uppercase mt-1 font-semibold tracking-wider">
